...
*Auto-generated 2026-07-14 from the live tracker. This always reflects the current set of stories (including any the scout has added). For the full curated write-ups, see the combined 2026 Edition brief.*
...
### Private credit's opaque expansion — 8/10 (High)
...
*Indicators watched:* US high-yield OAS (%, ≈310bps), Direct-lending default rate (%, Fitch incl. distressed exchanges), Large-fund redemption gates (0 none / 1 isolated / 2 widespread)
