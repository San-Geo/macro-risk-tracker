...
*Auto-generated 2026-07-04 from the live tracker. This always reflects the current set of stories (including any the scout has added). For the full curated write-ups, see the combined 2026 Edition brief.*

**Overall risk 6.2/10** — Set 1 5.4, Set 2 5.2, Set 3 4.8, Set 4 6.2, Set 5 5.5.
...
*Indicators watched:* US high-yield OAS (%, ≈310bps), Direct-lending default rate (%), Large-fund redemption gates (0 none / 1 isolated / 2 widespread)
